...
"""
    Module 1 Task 1
    minivan.py
    This app will check if the doors are open or not.
...
def doors_lockers(carArray):
    """
        This function will check if the doors of the minivan are open or not usign the following data.
    ...
    print("Gear shift position (P, N, D, 1, 2 ,3, or R): " + str(gs))
...
def main():
    """
        Run the app.
        It will assigne R1 value to the index swich[0].
        It will ask the user input and add it to the swich list.
        It will call doors_lockers function.
        It will return switch lisl.
    """
